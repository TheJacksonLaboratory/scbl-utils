...
class DataSet(Base):
    ...
    def set_batch_id(self, key: str, batch_id: None) -> int:
        ...
        # and institution both have the same autogenerated email and no
        # ORCID. If these two people submit on the same day, the
        # batch_id of the two datasets will be the same.
